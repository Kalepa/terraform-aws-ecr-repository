...
output "mutable" {
  description = "The value of the `mutable` input variable."
  value       = var.mutable
}
output "scan_on_push" {
  description = "The value of the `scan_on_push` input variable."
...
output "generate_authorization_token" {
  description = "The value of the `generate_authorization_token` input variable."
  value       = var.generate_authorization_token
}
output "create_repository_policy" {
  description = "The value of the `create_repository_policy` input variable."
...
output "create_lifecycle_policy" {
  description = "The value of the `create_lifecycle_policy` input variable."
...
output "create_policies" {
  description = "The value of the `create_policies` input variable."
  value       = var.create_policies
}
output "tags" {
  description = "The value of the `tags` input variable."
  value       = var.tags
}
