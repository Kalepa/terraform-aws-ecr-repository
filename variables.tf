...
variable "lifecycle_policy" {
  description = "The optional JSON-formatted lifecycle policy to apply to the repository. This variable only has an effect if the `create_lifecycle_policy` is set to `true`."
  type        = any
  default     = null
  validation {
